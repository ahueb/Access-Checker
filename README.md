Note: IEEE and Gale as programmed currently only work for the collection at UIS and JSTOR does not play nicely with this script, it is still a work in progress.
